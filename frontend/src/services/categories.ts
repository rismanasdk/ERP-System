...
export const categoriesApi = {
  ...
  update: async (id: number, payload: Partial<ProductCategory>, token?: string): Promise<ProductCategory> => (await api.put<ApiEnvelope<ProductCategory>>(`/api/v1/product-categories/${id}`, payload, token)).data,
