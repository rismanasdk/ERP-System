...
export type CustomerUpdatePayload = Partial<Customer> & { expected_version: number }
...
export const customersApi = {
  ...
  update: async (id: number, payload: CustomerUpdatePayload, token?: string): Promise<Customer> => {
