  ...
  return (
    <div className="grid grid-cols-1 gap-3 md:grid-cols-6 items-end">
      ...
      <div>
        ...
        <input value={unitCost} onChange={(e) => handleUnitCostChange(e.target.value)} type="number" min={0} step="0.01" className="mt-1 block w-full rounded-md border-slate-200 shadow-sm" />
      </div>
